...
const NavigationDesktop = () => {
  ...
  const showNav = () => {
    ...
    navRef.current.classList.contains('mobile_nav')?  setNavOpen(true) : setNavOpen(false);
  };
    ...
    >
      ...
      <AnimatePresence>
        ...
        >
          ...
          <form className='search_form' action='search'>
            <input className='search_input' type='text' placeholder='Search keyword ...' />
      ...
      </AnimatePresence>
      {
        ...
        (
            ...
            className='nav_btn' 
            onClick={showNav}>
                <img className='nav_btn_img' src="menuClose.svg" alt="hamburger menu" />
            </motion.button>
        ):
        (
            <motion.button
